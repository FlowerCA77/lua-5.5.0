/*
 ** $Id: luac.c $
 ** Lua compiler (saves bytecodes to files; also lists bytecodes) See Copyright Notice in lua.h
 */
...
static void PrintHeader(const Proto *f) {
    ...
    printf(
        "%d%s param%s, %d slot%s, %d upvalue%s, ", (int)(f->numparams), isvararg(f) ? "+" : "", SS(f->numparams),

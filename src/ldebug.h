/*
 ** $Id: ldebug.h $
 ** Auxiliary functions from Debug Interface module See Copyright Notice in lua.h
 */
...
/*
 ** MAXimum number of successive Instructions WiTHout ABSolute line information. (A power of two allows fast divisions.)
 */
